...
{
    public partial class Line2uDataContext : DbContext
    {
        public Line2uDataContext()
        {
        }
    private readonly IHttpContextAccessor _contextAccessor;

        public Line2uDataContext(DbContextOptions<Line2uDataContext> options, IHttpContextAccessor contextAccessor) : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("StoreRatingComment");
            ...
            modelBuilder.Entity<OrderDetailHistory>(entity =>
            {
                ...
                entity.Property(e => e.OrderDetailGuid)
                    .HasColumnName("ORDER_DETAIL_GUID")
                    .HasMaxLength(40);
